...
"arm-linux-thread-multi-2.6.37.1-1.2-desktop" or
	die "Errno architecture (arm-linux-thread-multi-2.6.37.1-1.2-desktop) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";

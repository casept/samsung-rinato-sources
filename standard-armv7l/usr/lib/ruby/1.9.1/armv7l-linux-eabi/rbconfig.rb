...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/1.9.1/armv7l-linux-eabi")
  ...
  CONFIG["configure_args"] = " '--build=armv7l-unknown-linux-gnueabi' '--host=armv7l-unknown-linux-gnueabi' '--target=armv7l-tizen-linux-gnueabi' '--program-prefix=' '--prefix=/usr' '--exec-prefix=/usr' '--bindir=/usr/bin' '--sbindir=/usr/sbin' '--sysconfdir=/etc' '--datadir=/usr/share' '--includedir=/usr/include' '--libexecdir=/usr/libexec' '--localstatedir=/var' '--sharedstatedir=/var/lib' '--mandir=/usr/share/man' '--infodir=/usr/share/info' '--disable-install-doc' '--disable-rpath' '--without-X11' '--without-tk' '--includedir=/usr/include/ruby' '--libdir=/usr/lib' 'build_alias=armv7l-unknown-linux-gnueabi' 'host_alias=armv7l-unknown-linux-gnueabi' 'target_alias=armv7l-tizen-linux-gnueabi' 'CFLAGS=-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Wl,--as-needed  -fmessage-length=0 -march=armv7-a -mtune=cortex-a8 -mlittle-endian  -mfpu=vfpv3 -mfloat-abi=softfp -D__SOFTFP__ -mthumb -Wa,-mimplicit-it=thumb' 'CXXFLAGS=-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Wl,--as-needed  -fmessage-length=0 -march=armv7-a -mtune=cortex-a8 -mlittle-endian  -mfpu=vfpv3 -mfloat-abi=softfp -D__SOFTFP__ -mthumb -Wa,-mimplicit-it=thumb'"
  CONFIG["vendordir"] = "$(rubylibprefix)/vendor_ruby"
  CONFIG["sitedir"] = "$(rubylibprefix)/site_ruby"
  CONFIG["ruby_version"] = "1.9.1"
  CONFIG["sitearch"] = "$(arch)"
  CONFIG["arch"] = "armv7l-linux-eabi"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Wl,--as-needed  -fmessage-length=0 -march=armv7-a -mtune=cortex-a8 -mlittle-endian  -mfpu=vfpv3 -mfloat-abi=softfp -D__SOFTFP__ -mthumb -Wa,-mimplicit-it=thumb"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = " $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L.  -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Wl,--as-needed  -fmessage-length=0 -march=armv7-a -mtune=cortex-a8 -mlittle-endian  -mfpu=vfpv3 -mfloat-abi=softfp -D__SOFTFP__ -mthumb -Wa,-mimplicit-it=thumb"
  CONFIG["CC"] = "gcc"
  CONFIG["target_os"] = "linux-eabi"
  CONFIG["target_vendor"] = "tizen"
  CONFIG["target_cpu"] = "armv7l"
  CONFIG["target"] = "armv7l-tizen-linux-gnueabi"
  CONFIG["host_os"] = "linux-gnueabi"
  CONFIG["host_vendor"] = "unknown"
  CONFIG["host_cpu"] = "armv7l"
  CONFIG["host"] = "armv7l-unknown-linux-gnueabi"
  CONFIG["build_os"] = "linux-gnueabi"
  CONFIG["build_vendor"] = "unknown"
  CONFIG["build_cpu"] = "armv7l"
  CONFIG["build"] = "armv7l-unknown-linux-gnueabi"
  ...
  CONFIG["target_alias"] = "armv7l-tizen-linux-gnueabi"
  CONFIG["host_alias"] = "armv7l-unknown-linux-gnueabi"
  CONFIG["build_alias"] = "armv7l-unknown-linux-gnueabi"
  ...
  CONFIG["includedir"] = "$(DESTDIR)/usr/include/ruby"

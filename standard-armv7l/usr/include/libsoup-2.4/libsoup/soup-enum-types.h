...
GType soup_socket_npn_type_get_type (void) G_GNUC_CONST;
#define SOUP_TYPE_SOCKET_NPN_TYPE (soup_socket_npn_type_get_type ())
...
GType soup_connection_spdy_error_get_type (void) G_GNUC_CONST;
#define SOUP_TYPE_CONNECTION_SPDY_ERROR (soup_connection_spdy_error_get_type ())
GType soup_connection_spdy_version_get_type (void) G_GNUC_CONST;
#define SOUP_TYPE_CONNECTION_SPDY_VERSION (soup_connection_spdy_version_get_type ())
G_END_DECLS

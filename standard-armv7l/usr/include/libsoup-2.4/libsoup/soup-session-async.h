...
#if defined ENABLE_TIZEN_PRECONNECTION && ENABLE_TIZEN_PRECONNECTION
void	soup_session_async_got_preconnection(SoupConnection *conn, guint status, SoupMessageQueueItem *item);
#endif

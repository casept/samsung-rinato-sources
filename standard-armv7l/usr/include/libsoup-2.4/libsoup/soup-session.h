...
/*#endif*/
/*#if ENABLE_TIZEN_PRECONNECTION*/
#define SOUP_SESSION_ALLOW_PRECONNECTION     "allow-preconnection"
/*#endif*/
/*#if ENABLE(TIZEN_PARALLEL_TCP_SYN)*/
#define SOUP_SESSION_ALLOW_PARALLEL_SYN      "allow-parallel-syn"
/*#endif*/

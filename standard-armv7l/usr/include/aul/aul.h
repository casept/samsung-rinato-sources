 ...
 * In case of in-house application, prefix is com.samsung.\n
 ...
 *	aul_launch_app("com.samsung.contact",b);
 * }
 *
 * @endcode
 * @remark
 ...
 * {
 *	if(aul_app_is_running("com.samsung.contact"))
 *		aul_open_app("com.samsung.contact");
 * }
 *
 * @endcode
 * @remark
 ...
 * {
 *	if(aul_app_is_running("com.samsung.contact"))
 *		aul_resume_app("com.samsung.contact");
 * }
 *
 * @endcode
 * @remark
 ...
 * {
 *	if(strcmp(info->pkg_name,"com.samsung.contact")==0)
 ...
 * {
 *      return aul_app_is_running("com.samsung.browser");
 * }
 *
 * @endcode
 * @remark
 ...
 * {
 *	aul_set_defapp_with_mime("text/html","com.samsung.browser");
 * }
 *
 * @endcode
 * @remark

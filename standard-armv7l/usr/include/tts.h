...
*/
typedef enum {
	TTS_VOICE_TYPE_AUTO,		/**< Auto-selected voice type from settings */
...
* @param[in] previous_voice_type A previous voice type
* @param[in] current_language A current language
* @param[in] current_voice_type A current voice type
* @param[in] user_data The user data passed from the callback registration function
*
* @see tts_set_default_voice_changed_cb()
*/
typedef void (*tts_default_voice_changed_cb)(tts_h tts, const char* previous_language, tts_voice_type_e previous_voice_type,
				const char* current_language, tts_voice_type_e current_voice_type, void* user_data);
...
/**
* @brief Sets the sound type of tts.
*
* @param[in] tts The handle for TTS
...
* @retval #TTS_ERROR_OPERATION_FAILED Operation failure
*
* @see tts_get_sound_type()
*/
int tts_set_sound_type(tts_h tts, tts_sound_type_e type);

/**
* @brief Gets the sound type of tts.
*
* @param[in] tts The handle for TTS
...
* @retval #TTS_ERROR_OPERATION_FAILED Operation failure
*
* @see tts_set_sound_type()
*/
int tts_get_sound_type(tts_h tts, tts_sound_type_e* type);
...
/**
* @brief Registers a callback function for detecting default voice change.
*
* @param[in] tts The handle for TTS
* @param[in] callback The callback function to register
* @param[in] user_data The user data to be passed to the callback function

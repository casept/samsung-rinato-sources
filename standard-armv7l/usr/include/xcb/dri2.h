...
/**
 * @brief xcb_dri2_swap_buffers_with_region_cookie_t
 **/
typedef struct xcb_dri2_swap_buffers_with_region_cookie_t {
    unsigned int sequence; /**<  */
} xcb_dri2_swap_buffers_with_region_cookie_t;

/** Opcode for xcb_dri2_swap_buffers_with_region. */
#define XCB_DRI2_SWAP_BUFFERS_WITH_REGION 50

/**
 * @brief xcb_dri2_swap_buffers_with_region_request_t
 **/
typedef struct xcb_dri2_swap_buffers_with_region_request_t {
    uint8_t        major_opcode; /**<  */
    uint8_t        minor_opcode; /**<  */
    uint16_t       length; /**<  */
    xcb_drawable_t drawable; /**<  */
    uint32_t       region; /**<  */
    uint8_t        pad0[20]; /**<  */
} xcb_dri2_swap_buffers_with_region_request_t;

/**
 * @brief xcb_dri2_swap_buffers_with_region_reply_t
 **/
typedef struct xcb_dri2_swap_buffers_with_region_reply_t {
    uint8_t  response_type; /**<  */
    uint8_t  pad0; /**<  */
    uint16_t sequence; /**<  */
    uint32_t length; /**<  */
    uint32_t swap_hi; /**<  */
    uint32_t swap_lo; /**<  */
} xcb_dri2_swap_buffers_with_region_reply_t;
...
/*****************************************************************************
 **
 ** xcb_dri2_swap_buffers_with_region_cookie_t xcb_dri2_swap_buffers_with_region
 ** 
 ** @param xcb_connection_t *c
 ** @param xcb_drawable_t    drawable
 ** @param uint32_t          region
 ** @returns xcb_dri2_swap_buffers_with_region_cookie_t
 **
 *****************************************************************************/
 
xcb_dri2_swap_buffers_with_region_cookie_t
xcb_dri2_swap_buffers_with_region (xcb_connection_t *c  /**< */,
                                   xcb_drawable_t    drawable  /**< */,
                                   uint32_t          region  /**< */);
...
/*****************************************************************************
 **
 ** xcb_dri2_swap_buffers_with_region_cookie_t xcb_dri2_swap_buffers_with_region_unchecked
 ** 
 ** @param xcb_connection_t *c
 ** @param xcb_drawable_t    drawable
 ** @param uint32_t          region
...
xcb_dri2_swap_buffers_with_region_cookie_t
xcb_dri2_swap_buffers_with_region_unchecked (xcb_connection_t *c  /**< */,
                                             xcb_drawable_t    drawable  /**< */,
                                             uint32_t          region  /**< */);
 ...
 * 
 * The parameter @p e supplied to this function must be NULL if
 * xcb_dri2_swap_buffers_with_region_unchecked(). is used.
 * Otherwise, it stores the error if any.
 *
 * The returned value must be freed by the caller using free().
 */
...
/*****************************************************************************
 **
 ** xcb_dri2_swap_buffers_with_region_reply_t * xcb_dri2_swap_buffers_with_region_reply
 ** 
 ** @param xcb_connection_t                            *c
 ** @param xcb_dri2_swap_buffers_with_region_cookie_t   cookie
 ** @param xcb_generic_error_t                        **e
 ** @returns xcb_dri2_swap_buffers_with_region_reply_t *
 **
 *****************************************************************************/
 
xcb_dri2_swap_buffers_with_region_reply_t *
xcb_dri2_swap_buffers_with_region_reply (xcb_connection_t                            *c  /**< */,
                                         xcb_dri2_swap_buffers_with_region_cookie_t   cookie  /**< */,
                                         xcb_generic_error_t                        **e  /**< */);

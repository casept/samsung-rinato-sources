 ...
 * @brief
 */
 #ifndef _MEDIA_UTIL_NOTI_INHOUSE_H_
#define _MEDIA_UTIL_NOTI_INHOUSE_H_
...
int media_db_update_send_inhouse(int pid, /* mandatory */
...
int media_db_update_subscribe_inhouse(MediaNotiHandle *handle, db_update_cb user_cb, void *user_data);

int media_db_update_unsubscribe_inhouse(MediaNotiHandle handle);
...
#endif /*_MEDIA_UTIL_NOTI_INHOUSE_H_*/

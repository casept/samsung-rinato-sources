...
int media_db_update_subscribe_multi(MediaNotiHandle *handle, db_update_cb user_cb, void *user_data);

int media_db_update_unsubscribe_multi(MediaNotiHandle handle, clear_user_data_cb clear_cb);

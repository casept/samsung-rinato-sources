...
#define AVSYS_STATE_WARNING					(0x70000000)					/**< Warning Class */
 ...
 * AVSYS_WARING
 */
#define AVSYS_STATE_WAR_INVALID_PARAMETER			(AVSYS_STATE_WARNING | AVSYS_IN_PARAMETER)
#define AVSYS_STATE_WAR_INVALID_HANDLE				(AVSYS_STATE_WARNING | AVSYS_IN_HANDLE)
#define AVSYS_STATE_WAR_INVALID_VALUE				(AVSYS_STATE_WARNING | AVSYS_IN_VALUE)
#define AVSYS_STATE_WAR_INVALID_MODE				(AVSYS_STATE_WARNING | AVSYS_IN_MODE)
#define AVSYS_STATE_WAR_INVALID_FORMAT				(AVSYS_STATE_WARNING | AVSYS_IN_FORMAT)
#define AVSYS_STATE_WAR_INVALID_CHANNEL				(AVSYS_STATE_WARNING | AVSYS_IN_CHANNEL)
#define AVSYS_STATE_WAR_INVALID_SAMPLERATE			(AVSYS_STATE_WARNING | AVSYS_IN_SAMPLERATE)
#define AVSYS_STATE_WAR_INVALID_LAYER				(AVSYS_STATE_WARNING | AVSYS_IN_LAYER)
#define AVSYS_STATE_WAR_INVALID_ROTATE				(AVSYS_STATE_WARNING | AVSYS_IN_ROTATE)
#define AVSYS_STATE_WAR_NULL_POINTER				(AVSYS_STATE_WARNING | AVSYS_IN_POINTER)
#define AVSYS_STATE_WAR_UNDERRUN					(AVSYS_STATE_WARNING | AVSYS_IN_UNDERRUN)
#define AVSYS_STATE_WAR_OVERRUN						(AVSYS_STATE_WARNING | AVSYS_IN_OVERRUN)
#define AVSYS_STATE_WAR_RANGE_OVER					(AVSYS_STATE_WARNING | AVSYS_IN_RANGE_OVER)
#define AVSYS_STATE_WAR_RANGE_UNDER					(AVSYS_STATE_WARNING | AVSYS_IN_RANGE_UNDER)
#define AVSYS_STATE_WAR_ALLOCATION					(AVSYS_STATE_WARNING | AVSYS_IN_ALLOC)
#define AVSYS_STATE_WAR_INTERNAL					(AVSYS_STATE_WARNING | AVSYS_IN_INTERNAL)
/*Extra warning for camera*/
#define AVSYS_STATE_WAR_IO_CONTROL					(AVSYS_STATE_WARNING | AVSYS_IN_IO_CONTROL)
#define AVSYS_STATE_WAR_UNAVAILABLE_DEVICE			(AVSYS_STATE_WARNING | AVSYS_IN_DEVICE)
#define AVSYS_STATE_WAR_DEVICE_WAIT_TIMEOUT			(AVSYS_STATE_WARNING | AVSYS_IN_WAIT_RES)
#define AVSYS_STATE_WAR_DEVICE_NOT_SUPPORT			(AVSYS_STATE_WARNING | AVSYS_IN_SUPPORT)
#define AVSYS_STATE_WAR_INVALID_STATE_TRANSITION	(AVSYS_STATE_WARNING | AVSYS_IN_STATE)
...
#define AVSYS_WARNING(_A_)					(AVSYS_STATE_WARNING & (_A_))

...
typedef enum {
	...
	VOLUME_TYPE_SVOICE,				/**< SVOICE volume type */
...
int mm_sound_volume_set_value_with_safety(volume_type_t type, const unsigned int value);
...
int mm_sound_set_DHA_control(MMSoundDHAMode_t mode, unsigned short *param);

...
typedef enum
{
	...
	ASM_EVENT_SHARE_MMCAMCORDER,     // It'll be deprecated
	ASM_EVENT_SHARE_MMSOUND,
	ASM_EVENT_SHARE_OPENAL,
	ASM_EVENT_SHARE_AVSYSTEM,
	ASM_EVENT_EXCLUSIVE_MMPLAYER,
	ASM_EVENT_EXCLUSIVE_MMCAMCORDER, // It'll be deprecated
...
typedef enum {
	...
	ASM_SUB_SESSION_TYPE_VOICE_ANSWER_PLAY,
	ASM_SUB_SESSION_TYPE_VOICE_ANSWER_REC,
	ASM_SUB_SESSION_TYPE_INIT,
	ASM_SUB_SESSION_TYPE_VR_NORMAL,
	ASM_SUB_SESSION_TYPE_VR_DRIVE,
	ASM_SUB_SESSION_TYPE_RECORD_STEREO,
	ASM_SUB_SESSION_TYPE_RECORD_STEREO_FOR_INTERVIEW,     /* directional stereo recording for interview */
	ASM_SUB_SESSION_TYPE_RECORD_STEREO_FOR_CONVERSATION,  /* directional stereo recording for conversation */
...
typedef enum
{
	...
	ASM_EVENT_SOURCE_VR_START,	/* VoiceRecognition Start */
	ASM_EVENT_SOURCE_VR_END,	/* VoiceRecognition End */
} ASM_event_sources_t;
...
typedef enum
{
	...
	ASM_STATUS_SHARE_MMCAMCORDER		= 0x00000002,  // It'll be deprecated
	...
	ASM_STATUS_EXCLUSIVE_MMCAMCORDER	= 0x00000040,  // It'll be deprecated
	...
	ASM_STATUS_VOIP						= 0x00010000,
	ASM_STATUS_MONITOR					= 0x80000000,
	ASM_STATUS_RICH_CALL				= 0x40000000,
	ASM_STATUS_EMERGENCY				= 0x00004000,
	ASM_STATUS_EXCLUSIVE_RESOURCE		= 0x00008000,
	ASM_STATUS_VOICE_RECOGNITION		= 0x00020000,
	ASM_STATUS_MMCAMCORDER_AUDIO		= 0x00040000,
	ASM_STATUS_MMCAMCORDER_VIDEO		= 0x00080000
} ASM_sound_status_t;
...
typedef enum
{
	...
	ASM_RESOURCE_EAR_SPK_PATH		= 0x4000,
	ASM_RESOURCE_SVR					= 0x8000,
	ASM_RESOURCE_VOICECONTROL		= 0x10000,
	ASM_RESOURCE_RESUMPTION_TAG		= 0x20000,
	ASM_RESOURCE_IOPRIORITY			= 0x40000,
}ASM_resource_t;
...
/* Sound blocking reason for applications */
typedef enum
{
	ASM_SOUND_BLOCKED_BY_TABLE         = 0x0, /* blocked by main table */
	ASM_SOUND_BLOCKED_BY_SOUND_PROFILE = 0x1, /* blocked by sound profile */
	ASM_SOUND_BLOCKED_BY_CUSTOM        = 0x2, /* blocked by custom reason */
} ASM_sound_blocked_reason_t;
...
typedef struct
{
	...
	ASM_sound_events_t			previous_sound_event;
	ASM_sound_blocked_reason_t	reason_of_blocking;

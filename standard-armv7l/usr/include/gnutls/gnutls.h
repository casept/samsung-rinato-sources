...
#define GNUTLS_MAX_ALGORITHM_NUM 16
   ...
   * @GNUTLS_HANDSHAKE_NEXT_PROTOCOL: Next Protocol Negotiation result
   *
  ...
  typedef enum
  {
    ...
    /* added for ENABLE_TIZEN_NPN */
    GNUTLS_HANDSHAKE_NEXT_PROTOCOL = 67
  } gnutls_handshake_description_t;
...
/* TLS Extensions */
  ...
  /* Next protocol negotiation for ENABLE_TIZEN_NPN */
  int gnutls_negotiate_next_protocol (gnutls_session_t session,
                                      const void *protocols,
                                      size_t protocols_length);
  int gnutls_get_next_protocol (gnutls_session_t session,
                                void *protocol, size_t *protocol_length,
                                unsigned int *supported);
  /* End of ENABLE_TIZEN_NPN */
